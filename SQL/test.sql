...
INSERT INTO `account_profile` (`id`, `address`, `cellphone`, `birthday`, `credit_card`, `user_id`, `photo`) VALUES
	(1, '台北市大安區忠孝東路三段277-4號', '0977777774', NULL, NULL, 2, 'None');
...
-- 正在傾印表格  internetbookstore.auth_group_permissions 的資料：~9 rows (大約)
...
INSERT INTO `auth_user` (`id`, `password`, `last_login`, `is_superuser`, `username`, `first_name`, `last_name`, `email`, `is_staff`, `is_active`, `date_joined`) VALUES
	(1, 'pbkdf2_sha256$100000$U4VA14URzxO2$rUxRRcvIc8eNoSsT4T/0D96EIouvlZf1cjiZm9GS41o=', '2018-01-01 13:43:18.502839', 1, 'admin', '', '', 'admin@gmail.com', 1, 1, '2017-12-30 10:25:39.290165'),
	(2, 'pbkdf2_sha256$100000$KLJxoywx6wbs$EJW2H4fPuepx2c5sa7FolRmkOo1FNxHLpmiQ7ZzDIuA=', '2018-01-01 09:19:26.859533', 0, 'wto2005716', 'Tsai', 'WenXue', 'wto2005716@yahoo.com.tw', 0, 1, '2017-12-30 10:26:27.300748'),
...
-- 正在傾印表格  internetbookstore.auth_user_groups 的資料：~1 rows (大約)
...
-- 傾印  表格 internetbookstore.comment_comment 結構
CREATE TABLE IF NOT EXISTS `comment_comment` (
  ...
  `user_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `comment_comment_book_id_60245be4_fk_IB_book_id` (`book_id`),
  KEY `comment_comment_user_id_6078e57b_fk_auth_user_id` (`user_id`),
  CONSTRAINT `comment_comment_book_id_60245be4_fk_IB_book_id` FOREIGN KEY (`book_id`) REFERENCES `ib_book` (`id`),
  CONSTRAINT `comment_comment_user_id_6078e57b_fk_auth_user_id` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8;

-- 正在傾印表格  internetbookstore.comment_comment 的資料：~10 rows (大約)
/*!40000 ALTER TABLE `comment_comment` DISABLE KEYS */;
INSERT INTO `comment_comment` (`id`, `content`, `timestamp`, `book_id`, `user_id`) VALUES
	(1, 'GOOD~~~', '2017-12-30 10:27:42.046195', 105, 2),
	(4, 'Nice to read~', '2017-12-30 14:55:47.191296', 37, 2),
	(5, '好看 哈哈', '2017-12-30 15:40:17.265335', 98, 2),
	(6, '喵喵喵~', '2017-12-31 06:13:30.628836', 17, 2),
	(7, '好看好看', '2017-12-31 06:44:54.704689', 98, 2),
	(8, '穿穿穿', '2017-12-31 06:48:59.026889', 93, 2),
	(9, '汪汪~~', '2017-12-31 06:50:09.399873', 132, 2),
	(10, '嗚嗚', '2017-12-31 06:50:52.695106', 132, 2),
	(11, 'XDXD', '2017-12-31 07:00:12.195454', 132, 2),
	(12, 'GOOD~~~~', '2017-12-31 22:16:14.074834', 56, 2);
...
-- 正在傾印表格  internetbookstore.django_admin_log 的資料：~5 rows (大約)
...
-- 正在傾印表格  internetbookstore.django_migrations 的資料：~33 rows (大約)
/*!40000 ALTER TABLE `django_migrations` DISABLE KEYS */;
INSERT INTO `django_migrations` (`id`, `app`, `name`, `applied`) VALUES
	(1, 'contenttypes', '0001_initial', '2017-12-30 10:21:58.182781'),
	(2, 'auth', '0001_initial', '2017-12-30 10:22:07.794424'),
	(3, 'Account', '0001_initial', '2017-12-30 10:22:09.122923'),
	(4, 'Account', '0002_auto_20171221_0230', '2017-12-30 10:22:11.364693'),
	(5, 'Account', '0003_remove_profile_photo', '2017-12-30 10:22:11.967488'),
	(6, 'Account', '0004_auto_20171228_0122', '2017-12-30 10:22:12.024982'),
	(7, 'IB', '0001_initial', '2017-12-30 10:22:17.501647'),
	(8, 'IB', '0002_auto_20171228_2143', '2017-12-30 10:22:21.435686'),
	(9, 'admin', '0001_initial', '2017-12-30 10:22:24.246131'),
	(10, 'admin', '0002_logentry_remove_auto_add', '2017-12-30 10:22:24.348653'),
	(11, 'orders', '0001_initial', '2017-12-30 10:22:52.887044'),
	(12, 'orders', '0002_auto_20171228_0339', '2017-12-30 10:22:56.236506'),
	(13, 'orders', '0003_auto_20171228_0340', '2017-12-30 10:22:56.816921'),
	(14, 'orders', '0004_auto_20171228_0358', '2017-12-30 10:22:58.365710'),
	(15, 'orders', '0005_auto_20171228_0429', '2017-12-30 10:22:59.784636'),
	(16, 'orders', '0006_auto_20171228_0429', '2017-12-30 10:22:59.917399'),
	(17, 'orders', '0007_auto_20171228_2143', '2017-12-30 10:22:59.969544'),
	(18, 'discount', '0001_initial', '2017-12-30 10:23:13.882378'),
	(19, 'discount', '0002_auto_20171228_2158', '2017-12-30 10:23:15.206822'),
	(20, 'discount', '0003_auto_20171230_1821', '2017-12-30 10:23:15.951394'),
	(21, 'contenttypes', '0002_remove_content_type_name', '2017-12-30 10:23:29.048706'),
	(22, 'auth', '0002_alter_permission_name_max_length', '2017-12-30 10:23:29.938837'),
	(23, 'auth', '0003_alter_user_email_max_length', '2017-12-30 10:23:30.706065'),
	(24, 'auth', '0004_alter_user_username_opts', '2017-12-30 10:23:30.778160'),
	(25, 'auth', '0005_alter_user_last_login_null', '2017-12-30 10:23:31.262447'),
	(26, 'auth', '0006_require_contenttypes_0002', '2017-12-30 10:23:31.311263'),
	(27, 'auth', '0007_alter_validators_add_error_messages', '2017-12-30 10:23:31.384073'),
	(28, 'auth', '0008_alter_user_username_max_length', '2017-12-30 10:23:35.455459'),
	(29, 'auth', '0009_alter_user_last_name_max_length', '2017-12-30 10:23:37.040514'),
	(30, 'comment', '0001_initial', '2017-12-30 10:23:38.662038'),
	(31, 'sessions', '0001_initial', '2017-12-30 10:23:39.223571'),
	(32, 'orders', '0008_orderlist_discount', '2017-12-31 21:47:55.821861'),
	(33, 'Account', '0005_profile_photo', '2018-01-01 09:19:56.420214'),
	(34, 'Account', '0006_auto_20180101_1720', '2018-01-01 09:20:35.280984');
...
INSERT INTO `django_session` (`session_key`, `session_data`, `expire_date`) VALUES
	('37ub8w736902mm4yqx3rt2yes9pbz59f', '', '2018-01-15 14:16:55.648363');
...
-- 正在傾印表格  internetbookstore.ib_book 的資料：~179 rows (大約)
...
-- 正在傾印表格  internetbookstore.orders_order 的資料：~7 rows (大約)
...
INSERT INTO `orders_order` (`id`, `shipment_cost`, `books_cost`, `order_date`, `shipment_date`, `arrival_date`, `account_id_id`, `address`, `phone`, `first_name`, `last_name`) VALUES
	(1, 60, 280, '2017-12-30 16:05:56.096655', '2018-01-01 03:57:36.000000', '2018-01-01 03:57:40.000000', 2, '台北市大安區忠孝東路三段277-4號', '0977777774', 'Tsai', 'WenXue'),
	(2, 60, 280, '2017-12-30 16:25:03.001555', NULL, NULL, 2, '台北市大安區忠孝東路三段277-4號', '0977777774', 'Tsai', 'WenXue'),
...
-- 正在傾印表格  internetbookstore.orders_orderlist 的資料：~9 rows (大約)
/*!40000 ALTER TABLE `orders_orderlist` DISABLE KEYS */;
INSERT INTO `orders_orderlist` (`id`, `book_quantity`, `book_id_id`, `order_id_id`, `price`, `discount`) VALUES
	(1, 1, 98, 1, 280, 0),
	(2, 1, 98, 2, 280, 0),
	(3, 1, 98, 3, 280, 0),
	(4, 1, 145, 4, 340, 0),
